...
public class Patron {
	 ...
	 *
	 * <p>
	 * The method creates a new {@link Loan} object that associates a book with the
	 * patron
	 * and updates the book with this loan information. The function also adds the
	 * book to the patron's list of borrowed books.
	 * </p>
	 *
	 * <p>
	 * If the book is on loan by another patron, an exception is thrown with a
	 * message saying that the book is currently on loan.
	 * </p>
	 *
	 * @param book    the book that will be borrowed by the patron
	 * @param dueDate the LocalDate that will be set as the loan's due date
